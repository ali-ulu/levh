...
comments, commits, code, issues, and other contributions that do not align
...
reported to the maintainers responsible for enforcement. Because this is a
single-maintainer project, reports go to the repository owner through a
[private security advisory](https://github.com/ali-ulu/levh/security/advisories/new)
or a direct message; the same confidential channel `SECURITY.md` describes.
...
warning from maintainers, providing clarity around the nature of the violation
